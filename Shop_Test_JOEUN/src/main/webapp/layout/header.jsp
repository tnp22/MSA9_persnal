...
<!--         </li> -->
        ...
        %>
        <li class="nav-item">
	        <a class="nav-link position-relative" aria-current="page" href="<%= root %>/shop/cart.jsp" style="line-height: 10px;">
	        	<i class="material-symbols-outlined" style="height: 24px !important;">shopping_bag</i>
	        	<span class="cart-count"><%= cartCount %></span>
	        </a>
        </li>
      </ul>
      <form class="d-flex mb-0" role="search" action="<%= root %>/shop/products.jsp" method="get">
