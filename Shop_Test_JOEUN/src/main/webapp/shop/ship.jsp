...
<!--         </li> -->
        ...
        <div class="dropdown">
	      ...
	      <ul class="dropdown-menu text-small shadow">
	        <li><a class="dropdown-item" href="/Shop/user/index.jsp">마이 페이지</a></li>
	        <li><a class="dropdown-item" href="/Shop/user/update.jsp">회원정보 수정</a></li>
	        <li><a class="dropdown-item" href="/Shop/user/order.jsp">주문내역</a></li>
	        <li><hr class="dropdown-divider"></li>
	        <li><a class="dropdown-item" href="/Shop/user/logout.jsp">로그아웃</a></li>
	      </ul>
	    </div>
        </li>
